...
[`@aws-sdk/client-appconfigdata`](https://www.npmjs.com/package/@aws-sdk/client-appconfigdata/v/3.315.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appconfigdata@3.315.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j1adKAMQBLE5D32YNTih0ddOxy55D8jORfr1yzOrhDSze40LD1tH8lhfthoHpl1s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-appconfigdata": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appconfigdata@3.315.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appconfigdata@3.315.0/index.min.mjs": "sha384-j1adKAMQBLE5D32YNTih0ddOxy55D8jORfr1yzOrhDSze40LD1tH8lhfthoHpl1s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-appconfigdata/blob/refs/tags/3.315.0/LICENSE
```
