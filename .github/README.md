...
[`@aws-sdk/client-appconfigdata`](https://www.npmjs.com/package/@aws-sdk/client-appconfigdata/v/3.936.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appconfigdata@3.936.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PpIviIPNwMeGXnSuErsh4+bHOn1xs/dX8ZiqAOKYhEG80Ht8GDShoRxHZDB+UuP5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-appconfigdata": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appconfigdata@3.936.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appconfigdata@3.936.0/index.min.mjs": "sha384-PpIviIPNwMeGXnSuErsh4+bHOn1xs/dX8ZiqAOKYhEG80Ht8GDShoRxHZDB+UuP5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-appconfigdata/blob/refs/tags/3.936.0/LICENSE
```
